...
function Nav() {
  ...
  const [navBlack, setNavBlack] =
    useState(false); /* detecte la nav bar quand on scrolle */
  ...
  return (
    <div
      ...
      <img src="//upload.wikimedia.org/wikipedia/commons/thumb/0/08/Netflix_2015_logo.svg/799px-Netflix_2015_logo.svg.png" className="nav__logo" alt="Netflix" />
